...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8c67ca00e71c686007ab803678144bf5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "`Dyntype` is a syntax extension which makes OCaml types and values easier to manipulate programmatically.";
          description = None;
          categories = [];
          ...
          conf_custom =
            {
               ...
               post_command =
                 [(OASISExpr.EBool true, Some (("./post_conf.sh", [])))];
               };
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("type_conv", None)];
                      bs_build_tools =
                   ...
                   {
                      lib_modules = ["Type"; "Value"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "dyntype";
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "dyntype";
               ...
               Test
                 ({
                     ...
                     },
                   {
                      ...
                      test_command = [(OASISExpr.EBool true, ("$suite", []))];
                      test_custom =
                        {
                           pre_command = [(OASISExpr.EBool true, None)];
                           post_command = [(OASISExpr.EBool true, None)];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "Q\253\130\221\161v\214\140\181\000}\017\239\249\t\254";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
